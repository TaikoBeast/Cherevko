...
class FileHandler:
    ...
    def _read_file(self) -> List[Dict]:
        ...
        if self.file_path.suffix == ".json":
            ...
            raise ValueError(f"Непідтримуваний формат файлу: {self.file_path.suffix}")
...
def main():
    ...
    group.add_argument("--percentage-all", action="store_true", help="Показать проценты по условиям для всех")
